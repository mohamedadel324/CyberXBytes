        ...
        <tr>
            <td align="center" style="padding: 20px 0;">
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="center" style="padding: 20px 0;">
                            <img src="https://red-armadillo-871677.hostingersite.com/logo3.png" alt="Logo" width="60" height="60" style="border-radius: 50%;">
                        </td>
                    </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#131619" style="border-radius: 15px; margin: 20px 0;">
                                <tr>
                                    <td align="center" style="padding: 30px;">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td align="center" style="padding-bottom: 30px;">
                                                    <img src="{{ $user->profile_image ?? 'https://red-armadillo-871677.hostingersite.com/user.webp' }}" alt="Profile" width="80" height="80" style="border-radius: 50%; object-fit: cover;">
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <!-- Verification Code -->
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#131619" style="border-radius: 15px; margin: 20px 0;">
                                            <tr>
