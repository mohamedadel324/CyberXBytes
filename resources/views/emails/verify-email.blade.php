                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td align="center" style="color: #ffffff; font-size: 14px; line-height: 1.5; padding-bottom: 25px;">
                                                    <p style="margin: 0 0 10px 0;">For security reasons, please help us by verifying your email address.</p>
                                                    <p style="margin: 0;">Verify within 48 days of first signing up to avoid the deactivation of your account.</p>
                                                </td>
                                            </tr>
                                        </table>
                                                    ...
                                                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            <td bgcolor="#00edb1" style="padding: 12px 30px; border-radius: 25px;">
                                                                <a href="{{ $verificationUrl }}" style="color: #000000; font-weight: bold; text-decoration: none; display: inline-block; font-size: 14px;">Get started</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td align="center" style="color: #ffffff; font-size: 14px; line-height: 1.5; padding-top: 10px;">
                                                    ...
                                                    <p style="margin: 0;"><a href="{{ $verificationUrl }}" class="verification-link" style="color: #00edb1; word-break: break-word;">{{ $verificationUrl }}</a></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
